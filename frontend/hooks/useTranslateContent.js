...
const translations = {
  ...
  'Hébergement 1 nuit (hôtel + camp nomade)': { en: '1 night accommodation (hotel + nomad camp)', fr: 'Hébergement 1 nuit (hôtel + camp nomade)' },
  'Guide professionnel sur site': { en: 'Professional guide on site', fr: 'Guide professionnel sur site' },
  'Nuit dans une maison d\'hôtes': { en: 'Night in a guesthouse', fr: 'Nuit dans une maison d\'hôtes' },
  'Animation': { en: 'Entertainment', fr: 'Animation' },
  'Music': { en: 'Music', fr: 'Musique' },
  'Déjeuners (environ 10& 15€/repas)': { en: 'Lunches (about €10-15/meal)', fr: 'Déjeuners (environ 10& 15€/repas)' },
  'Jour 1 : Marrakech → Col du Tichka → Ouarzazate → Vallée des Roses→ Vallée du Dadès (nuit à Boumalne)': { en: 'Day 1: Marrakech → Tichka Pass → Ouarzazate → Valley of Roses → Dadès Valley (overnight in Boumalne)', fr: 'Jour 1 : Marrakech → Col du Tichka → Ouarzazate → Vallée des Roses→ Vallée du Dadès (nuit à Boumalne)' },
  'Jour 2 : Gorges du Dadès → Gorges du Todra → Erfoud → Merzouga': { en: 'Day 2: Dadès Gorges → Todra Gorges → Erfoud → Merzouga', fr: 'Jour 2 : Gorges du Dadès → Gorges du Todra → Erfoud → Merzouga' },
  'Jour 2 : Lever de soleil sur les dunes → Retour Marrakech via Ouarzazate': { en: 'Day 2: Sunrise over the dunes → Return to Marrakech via Ouarzazate', fr: 'Jour 2 : Lever de soleil sur les dunes → Retour Marrakech via Ouarzazate' },
