                ...
                <div className="grid sm:grid-cols-3 gap-4 max-w-xl mx-auto mb-10">
                  ...
                  <div className="flex items-center gap-3 p-4 rounded-2xl bg-white/5 border border-white/10">
                    ...
                    <div className="text-left min-w-0">
                      ...
                      <a href="mailto:contact@trendytravelmarrakech.com" className="block max-w-full text-sm font-bold text-white hover:text-blue-400 transition truncate">contact@trendytravelmarrakech.com</a>
                    </div>
                  </div>
                  <div className="flex items-center gap-3 p-4 rounded-2xl bg-white/5 border border-white/10">
                    <span className="text-2xl">💬</span>
