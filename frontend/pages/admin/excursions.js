          ...
          {destinations.map((destination) => (
            <div key={destination.id} className="bg-white rounded-lg shadow p-4">
              ...
              <div className="flex gap-4 text-sm mb-3">
                ...
                {destination.price && <span className="font-semibold text-green-700">{destination.price} $/pers.</span>}
              </div>
              <div className="flex gap-2">
            ...
            <tbody className="bg-white divide-y divide-gray-200">
              {destinations.map((destination) => (
                <tr key={destination.id}>
                  ...
                  <td className="px-6 py-4 text-sm font-semibold text-green-700">{destination.price ? `${destination.price} $/pers.` : '-'}</td>
                  <td className="px-6 py-4">
