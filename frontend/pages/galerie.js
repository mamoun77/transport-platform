...
export default function Galerie() {
  ...
  return (
    <>
      <Head>
        <title>{t('home:gallery.title')} — Trendy Travel Marrakech</title>
      </Head>
      <div className="min-h-screen bg-[#080d1a] text-white">
        ...
        <div className="max-w-7xl mx-auto px-6 pt-32 pb-24">
          <div className="text-center mb-14">
            ...
            <h1 className="text-4xl sm:text-5xl font-extrabold bg-gradient-to-r from-white to-pink-300 bg-clip-text text-transparent">{t('home:gallery.title')}</h1>
          </div>

          {photos.length === 0 ? (
            <div className="text-center py-20 text-slate-500">{t('home:gallery.empty')}</div>
          ) : (
